...
//    Version[] versions = { // Construct the data model
...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = findViewById(R.id.recyclerView); // Identify and store the RecyclerView with find by id.
        recyclerView.setLayoutManager(new LinearLayoutManager(this)); // call setLayoutManager to set the layout manager to LinearLayoutManager.
        MyAdapter myAdapter = new MyAdapter();
        //myAdapter.addElements(versions);
        recyclerView.setAdapter(myAdapter);
        queue = Volley.newRequestQueue(this);
        JsonArrayRequest request =
                new JsonArrayRequest(Request.Method.GET, " https://raw.githubusercontent.com/kenobicjj/android/main/tutorial4.json ", null, new Response.Listener<JSONArray>() {
                    @Override
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
        ArrayList<Version> elements = new ArrayList<Version>();// Declare and initialize the ArrayList
        ...
        public int getItemCount() {
            return elements.size(); // form returning a zero we edited this one to return the elements size.
        }
        ...
        class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public MyViewHolder(@NonNull View itemView) { // identify and store all the views.
                super(itemView);
                textView = itemView.findViewById(R.id.verstxt);
                textView2 = itemView.findViewById(R.id.numtxt);
